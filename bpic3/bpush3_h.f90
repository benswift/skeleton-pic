...
!
     ...
     &ny,nz,nxv,nyv,nzv,ipbc)
         ...
         real :: qbm, dt, dtc, ek
         real, dimension(idimp,nop) :: part
         real, dimension(3,nxv,nyv,nzv) :: fxyz, bxyz
         end subroutine
      end interface
!
      interface
...
!
     ...
     &nzv,ipbc)
         ...
         real :: qm, dt
         real, dimension(idimp,nop) :: part
         real, dimension(3,nxv,nyv,nzv) :: cu
         end subroutine
      end interface
!
      interface
...
!
      interface
         ...
         implicit none
         integer :: nx, ny, nz, nxe, nye, nze
         real, dimension(3,nxe,nye,nye) :: cu
         end subroutine
      end interface
!
      interface
...
!
     ...
     &nxhd,nyhd,nzhd)
         ...
         real :: ci, wm
         real, dimension(3,2*nxvh,nyv,nzv) :: cu
         complex, dimension(3,nxvh,nyv,nzv) :: bxyz
         complex, dimension(nxhd,nyhd,nzhd) :: ffc
         end subroutine
      end interface
!
     ...
     &nyv,nzv,nxhd,nyhd,nzhd)
         ...
         integer :: nx, ny, nz, nxvh, nyv, nzv, nxhd, nyhd, nzhd
         real :: ci, dt, wf, wm
         complex, dimension(3,nxvh,nyv,nzv) :: exyz, bxyz
         real, dimension(3,2*nxvh,nyv,nzv) :: cu
         complex, dimension(nxhd,nyhd,nzhd) :: ffc
         end subroutine
      end interface
!
     ...
     &nxhd,nyhd,nzhd)
         ...
         integer :: isign, nx, ny, nz, nxvh, nyv, nzv, nxhd, nyhd, nzhd
         real, dimension(3,2*nxvh,nyv,nzv) :: fxyz
         complex, dimension(3,nxvh,nyv,nzv) :: exyz
         complex, dimension(nxhd,nyhd,nzhd) :: ffc
         end subroutine
      end interface
!
