...
c f(2*j-1,k,l),f(2*j,k,l) = real, imaginary part of mode j-1,k-1,l-1
c where 1 <= j <= nx/2, 1 <= k <= ny, 1 <= l <= nz, except for
c f(1,k,l),f(2,k,l) = real, imaginary part of mode nx/2,k-1,l-1,
c where ny/2+2 <= k <= ny and 1 <= l <= nz, and
c f(1,1,l),f(2,1,l) = real, imaginary part of mode nx/2,0,l-1,
c f(1,ny/2+1,l),f(2,ny/2+1,l) = real, imaginary part mode nx/2,ny/2,l-1,
c where nz/2+2 <= l <= nz, and
c f(2,1,1) = real part of mode nx/2,0,0
c f(2,ny/2+1,1) = real part of mode nx/2,ny/2,0
c f(2,1,nz/2+1) = real part of mode nx/2,0,nz/2
c f(2,ny/2+1,nz/2+1) = real part of mode nx/2,ny/2,nz/2
